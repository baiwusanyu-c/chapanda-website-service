    ...
    steps:
      ...
      - name: Deploy to server
        ...
        run: |
            ...
            pnpm run build
            mkdir -p dist/env
            echo 'MYSQL_ROOT_PASSWORD=$MYSQL_ROOT_PASSWORD' >> dist/env/.env
            echo 'MYSQL_ROOT_USER=$MYSQL_ROOT_USER' >> dist/env/.env
            echo 'MYSQL_SERVER_HOST=$MYSQL_SERVER_HOST' >> dist/env/.env
            echo 'REDIS_SERVER_HOST=$REDIS_SERVER_HOST' >> dist/env/.env
            echo 'REDIS_ROOT_PASSWORD=$REDIS_ROOT_PASSWORD' >> dist/env/.env
            echo 'MINIO_SERVER_HOST=$MINIO_SERVER_HOST' >> dist/env/.env
            echo 'MINIO_SERVER_ACCESS=$MINIO_SERVER_ACCESS' >> dist/env/.env
            echo 'MINIO_SERVER_SECRET=$MINIO_SERVER_SECRET' >> dist/env/.env
            echo 'MINIO_SERVER_BUKET=$MINIO_SERVER_BUKET' >> dist/env/.env
...
## TODO: 配置 nginx
## TODO: 配置 minio 的 Access key 和 Secret
## TODO:CI/CD 环境变量配置
